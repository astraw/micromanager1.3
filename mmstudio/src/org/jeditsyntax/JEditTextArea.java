...
public class JEditTextArea extends JComponent
{
   ...
   /**
    * Keeps track of undoable edits
    */
   protected UndoManager undo = new UndoManager();

   /**
    * Undoanle edit listener adds the edit to the undo Manager
    */
   ...
   */
	...
	/**
	 * Replaces the document content with text read from an inputStream
	 */
	public void read(InputStreamReader in)
	{
      ...
      try {
         while ( (bytesRead = in.read(buf, 0, 1024)) > 1) {
            final String text = new String (buf, 0, bytesRead);
