...
public class ContrastPanel extends JPanel implements ImageController {
	...
	public ContrastPanel() {
		...
		add(minField_);
		springLayout.putConstraint(SpringLayout.EAST, minField_, 80,
				SpringLayout.WEST, this);
		springLayout.putConstraint(SpringLayout.WEST, minField_, 29,
				SpringLayout.WEST, this);
		...
		add(maxField_);
		springLayout.putConstraint(SpringLayout.EAST, maxField_, 80,
				SpringLayout.WEST, this);
		springLayout.putConstraint(SpringLayout.WEST, maxField_, 29,
				SpringLayout.WEST, this);
		...
		springLayout.putConstraint(SpringLayout.NORTH, minLabel_, 64,
				SpringLayout.NORTH, this);
		springLayout.putConstraint(SpringLayout.EAST, minLabel_, 30,
				SpringLayout.WEST, this);
		springLayout.putConstraint(SpringLayout.WEST, minLabel_, 5,
				SpringLayout.WEST, this);
		...
		springLayout.putConstraint(SpringLayout.NORTH, maxLabel_, 80,
				SpringLayout.NORTH, this);
		springLayout.putConstraint(SpringLayout.EAST, maxLabel_, 30,
				SpringLayout.WEST, this);
		springLayout.putConstraint(SpringLayout.WEST, maxLabel_, 5,
				SpringLayout.WEST, this);
		...
		springLayout.putConstraint(SpringLayout.NORTH, sliderHigh_, 28,
				SpringLayout.SOUTH, histogramPanel_);
		springLayout.putConstraint(SpringLayout.SOUTH, histogramPanel_, -57,
		...
		if (image_ != null) {
			...
			if (image_.getProcessor() != null) {
				...
				MMLogger
						.getLogger()
						.info(
								"ContrastPanel.updateSliders(): image_.getProcessor() == null");
			}
		}
	...
	private void setFullScale() {
		...
		if (image_.getProcessor() instanceof ShortProcessor) {
			...
			image_.getProcessor().setMinAndMax(0, 255);
			maxIntensity_ = 255;
		}
		image_.updateAndDraw();
		updateSliders();
